...
public class tutorialestudiante extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(this.mediaController==null){
            this.mediaController=new MediaController(tutorialestudiante.this);
    ...
    public void closee(View view) {
        Intent closetuto = new Intent(tutorialestudiante.this, inicioestudiante.class );
