...
public class tutorialpadres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(this.mediaController==null){
            this.mediaController=new MediaController(tutorialpadres.this);
    ...
    public void closee(View view) {
        Intent closetuto = new Intent(tutorialpadres.this, iniciopadres.class );
